...
^http[s]?:\/\/((app|api)\.(\w{2,15})?\.(com|cn)).*player\.(v3|v2|v1).Play(URL|View).*$ url script-request-header https://raw.githubusercontent.com/Abinthur/Quantumult-X-For-Personal-Use/main/scripts/BilibiliProCrack.js
